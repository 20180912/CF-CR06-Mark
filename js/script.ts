...
class Loc {
    ...
    zipCode;
    address;
    constructor(image:string, name:string, city:string, zipCode:string, address:string) {
        this.image = image;
        this.name = name;
        this.city = city;
...
class Restaurant extends Loc {
    ...
    cuisine;
    website;
    constructor (image:string, name:string, city:string, zipCode:string, address:string, telephone:string, cuisine:string, website:string) {
...
class Eve extends Loc {
    ...
    eventTime;
    ticketPrice;
    constructor (image:string, name:string, city:string, zipCode:string, address:string, eventDate: string, eventTime:string, ticketPrice:string) {
        super(image, name, city, zipCode, address);
