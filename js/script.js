...
class Loc {
    constructor(image, name, city, zipCode, address, dateCreated = "", timeCreated = "") {
        this.image = image;
        this.name = name;
        this.city = city;
...
class Restaurant extends Loc {
    constructor(image, name, city, zipCode, address, telephone, cuisine, website, dateCreated = "", timeCreated = "") {
...
class Eve extends Loc {
    constructor(image, name, city, zipCode, address, eventDate, eventTime, ticketPrice, dateCreated = "", timeCreated = "") {
        super(image, name, city, zipCode, address, dateCreated, timeCreated);
